...
public class ElementsList {
	...
	public List<WebElement> firstRowElements() {
		return tableElement.findElement(By.xpath(ElementsList.rowContainerLocator))
	...
	public List<WebElement> getRowElementsFor(List<String> headings) {
		...
		List<WebElement> rowCandidates = tableElement
				.findElements(By.xpath(ElementsList.rowForHeadingLocator + headings.size() + "]"));
		
		System.out.println("heading locator"+ElementsList.rowForHeadingLocator + headings.size() + "]");
		System.out.println("size"+rowCandidates.size());
		System.out.println(headings.get(0));
	...
	private boolean hasMatchingCellValuesIn(WebElement firstRow, List<String> headings) {
		...
		System.out.println("headings "+headings.get(0));
		System.out.println("cellss size "+cells.size());
		System.out.println("text is "+cells.get(0).getText());
	...
	private List<WebElement> cellsIn(WebElement row) {
		return row.findElements(By.xpath(ElementsList.rowLocator));
	}
