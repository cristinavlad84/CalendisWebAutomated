...
public class FacebookLoginIntoClientAccountStory extends BaseTest {
	...
	public void readFromFile() {
		String fileName = Constants.OUTPUT_PATH
				+ ConfigUtils.getOutputFileNameForFacebookClientAccount();
	...
	public void login_into_client_account() throws Exception {
		...
		loginStep.click_on_facebook_login_button();
