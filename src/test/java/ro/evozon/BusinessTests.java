...
@SuiteClasses({ CreateNewBusinessAccountStory.class,
		...
		EditLocationFromBusinessAccountStory.class,
		DeleteLocationFromBusinessAccountStory.class,
		AddNewDomainFromBusinessAccountStory.class,
		DeleteDomainFromBusinessAccountStory.class,
		...
		AddNewServiceFromBusinessAccountStory.class,
		EditServiceFromBusinessAccountStory.class,
		DeleteServiceFromBusinessAccountStory.class,
		LoginAsSpecialistStory.class, LoginAsReceptionistStory.class,
