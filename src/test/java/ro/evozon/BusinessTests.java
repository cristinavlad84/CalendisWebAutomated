...
@SuiteClasses({ CreateNewBusinessAccountStory.class, LoginIntoBusinessAccountStory.class,
		...
		LoginAsColaboratorStory.class, 	AddPriceListFromBusinessAccountStory.class, AddNewQuickAppointmentStory.class, EditAppointmentStory.class,
		AddNewClientStory.class, AddDiscountGroupStory.class, AddClientToGroupStory.class,
